...
public enum MembershipRequestStatus {
    OPEN("OPEN"), REJECTED("REJECTED"), APPROVED("APPROVED");

    private String text;

    MembershipRequestStatus(String text){this.text = text;}
    ...
    public static MembershipRequestStatus fromText(String text){
        for(MembershipRequestStatus status : MembershipRequestStatus.values()){
